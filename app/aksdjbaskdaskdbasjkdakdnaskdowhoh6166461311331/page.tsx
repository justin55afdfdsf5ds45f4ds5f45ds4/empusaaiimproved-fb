        ...
        <div className="w-full max-w-md p-8 bg-white rounded-lg shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between">
              ...
              <Link href="mailto:justinlord@empusaai.com" className="text-sm text-teal-600 hover:text-teal-700">
                Forgot password?
              </Link>
            </div>
          ...
          <div className="text-center mt-6">
            <p className="text-sm text-gray-500">
              ...
              <Link href="/aksdjbaskdaskdbasjkdakdnaskdowhoh6166461311331/signup" className="text-teal-600 hover:text-teal-700 font-medium">
                Sign up
              </Link>
            </p>
          </div>
